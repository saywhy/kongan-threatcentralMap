    ...
    <div class="home-top">
      ...
      <div class="home_r">
        ...
        <el-button type="primary"
          ...
          <span v-if="!isFull">
            <i class="full"></i>
            <span class="name">全屏</span>
          </span>
          <span v-if="isFull">
            <i class="refull"></i>
            <span class="name">退出全屏</span>
          </span>
        </el-button>
      </div>
    </div>
          ...
          .el-input {
            ...
            .el-input__inner {
              ...
              background-image: radial-gradient(
                49% 87%,
                rgba(10, 113, 255, 0.42) 5%,
                rgba(10, 113, 255, 0.12) 88%,
                rgba(10, 113, 255, 0.12) 88%
              );
    ...
    .screen-2 {
      ...
      .list-item-bottom {
        ...
        .title-flow {
          ...
          background-image: radial-gradient(
            49% 86%,
            rgba(10, 113, 255, 0.72) 0%,
            rgba(10, 113, 255, 0.12) 86%
          );
